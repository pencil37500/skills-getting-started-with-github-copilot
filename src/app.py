...
activities = {
    ...
    "Swim Club": {
        "description": "Improve swimming technique and compete in friendly swim meets",
        "schedule": "Wednesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["karen@mergington.edu", "miguel@mergington.edu"]
    },
    "Art Studio": {
    ...
    "Music Ensemble": {
        "description": "Practice musical pieces and perform for school events",
